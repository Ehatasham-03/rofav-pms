...
function RoomTypePhotoComponent({ roomId = '' }) {
  ...
  useEffect(() => {
    (async function () {
      try {
        const response = await api(`/room-images/${roomId}`, {}, 'get');
  ...
  const handleFileSubmit = async () => {
    ...
    try {
      ...
      let res = await api(`/upload-room-files/${roomId}`, formData, 'postFile');
  ...
  return (
    <div className="border border-[#bbbbb] rounded-[12px] shadow-sm p-6">
      <div className="mb-[30px]">
        ...
        <div className="mt-4 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 lg:grid-cols-12 gap-4 mb-[30px]">
...
export default RoomTypePhotoComponent;
