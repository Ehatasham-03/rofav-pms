                                      ...
                                      >
                                        <div className="col-span-2">
                                          <Input
                                            ...
                                            value={values.rooms[index]?.roomNo}
                                          />
                                        </div>
                                        ...
                                        <div>
                                          <Input
                                            ...
                                            value={values.rooms[index]?.floorNo}
                                          />
                                        </div>
                                        ...
                                        {values.rooms.length > 1 && (
                                          <ActionColumn
                                            id={values.rooms[index]?.uniqueId}
                                            setReload={() =>
...
const ActionColumn = ({ id = "", setReload = () => {} }) => {
