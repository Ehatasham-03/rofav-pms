 ...
 *     // -or-
 *     return res.sendResponse(optionalData);
 * ```
 *
 * Or with actions2:
 * ```
...
module.exports = function sendResponse(statusCodeToSet = 400, optionalData) {
  ...
  if (optionalData === undefined) {
    sails.log.info('Ran custom response: res.sendResponse()');
  ...
  //   sails.log.info('Custom response `res.sendResponse()` called with an Error:', optionalData);
