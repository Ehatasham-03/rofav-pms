...
module.exports = {
  friendlyName: 'Update channex hotel policy',
    ...
    await axios
      .put(
        process.env.CHANNEX_ENDPOINT +
          `/hotel_policies/${inputs.policyChannexId}`,
        {
          hotel_policy: {
            title: inputs.title,
            ...
            parking_reservation: inputs.parking_reservation,
      ...
      .then(async (result) => {
        ...
        if (!result.data || !result.data.hotel_policy) {
