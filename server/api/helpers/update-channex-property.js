...
module.exports = {
  friendlyName: 'Update channex property',
  ...
  fn: async function (inputs, exits) {
    await axios
      .put(
        process.env.CHANNEX_ENDPOINT + `/properties/${inputs.channexId}`,
        {
          property: {
            title: inputs.title,
            ...
            hotel_policy_id: inputs.hotel_policy_id || null,
            settings: {
              allow_availability_autoupdate_on_confirmation:
              ...
              min_price: inputs.min_price
                ? Number(inputs.min_price) * 100
                : null,
              max_price: inputs.max_price
                ? Number(inputs.max_price) * 100
                : null,
